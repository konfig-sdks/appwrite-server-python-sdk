...
from appwrite_server_python_sdk.exceptions_base import ApiValueError
from appwrite_server_python_sdk.exceptions import ClientConfigurationError
...
conf = appwrite_server_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        if forwarded_user_agent:
            self.api_key['ForwardedUserAgent'] = forwarded_user_agent
        if jwt:
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("appwrite_server_python_sdk")
    ...
    def auth_settings(self):
        ...
        """
        auth = {}
        if 'ForwardedUserAgent' in self.api_key:
            auth['ForwardedUserAgent'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'X-Forwarded-User-Agent',
