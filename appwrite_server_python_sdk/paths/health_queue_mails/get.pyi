...
class BaseApi(api_client.Api):
    ...
    def _get_mail_queue_size_mapped_args(
        self,
    ...
    async def _aget_mail_queue_size_oapg(
        self,
...
class GetMailQueueSizeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_mail_queue_size(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_mail_queue_size_mapped_args(
            threshold=threshold,
        )
        return await self._aget_mail_queue_size_oapg(
    ...
    def get_mail_queue_size(
        ...
        return self._get_mail_queue_size_oapg(
            query_params=args.query,
        )

class GetMailQueueSize(BaseApi):
    ...
    async def aget_mail_queue_size(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_mail_queue_size(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_mail_queue_size(
        ...
        raw_response = self.raw.get_mail_queue_size(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
