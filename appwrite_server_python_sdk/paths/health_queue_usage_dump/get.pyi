...
class BaseApi(api_client.Api):
    ...
    def _get_queue_usage_dump_mapped_args(
        self,
    ...
    async def _aget_queue_usage_dump_oapg(
        self,
    ...
    def _get_queue_usage_dump_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetQueueUsageDumpRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_queue_usage_dump(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_queue_usage_dump_mapped_args(
            threshold=threshold,
        )
        return await self._aget_queue_usage_dump_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_queue_usage_dump(
        self,
        threshold: typing.Optional[int] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_queue_usage_dump_oapg(
            query_params=args.query,
        )

class GetQueueUsageDump(BaseApi):
    ...
    async def aget_queue_usage_dump(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_queue_usage_dump(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_queue_usage_dump(
        ...
        raw_response = self.raw.get_queue_usage_dump(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
