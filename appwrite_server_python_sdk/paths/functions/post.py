...
from appwrite_server_python_sdk.model.functions_create_new_function_request_execute import FunctionsCreateNewFunctionRequestExecute as FunctionsCreateNewFunctionRequestExecuteSchema
from appwrite_server_python_sdk.model.function import Function as FunctionSchema
from appwrite_server_python_sdk.model.functions_create_new_function_request_events import FunctionsCreateNewFunctionRequestEvents as FunctionsCreateNewFunctionRequestEventsSchema
from appwrite_server_python_sdk.model.functions_create_new_function_request import FunctionsCreateNewFunctionRequest as FunctionsCreateNewFunctionRequestSchema

from appwrite_server_python_sdk.type.function import Function
...
from appwrite_server_python_sdk.type.functions_create_new_function_request import FunctionsCreateNewFunctionRequest
...
from appwrite_server_python_sdk.pydantic.functions_create_new_function_request_events import FunctionsCreateNewFunctionRequestEvents as FunctionsCreateNewFunctionRequestEventsPydantic
from appwrite_server_python_sdk.pydantic.functions_create_new_function_request import FunctionsCreateNewFunctionRequest as FunctionsCreateNewFunctionRequestPydantic
from appwrite_server_python_sdk.pydantic.functions_create_new_function_request_execute import FunctionsCreateNewFunctionRequestExecute as FunctionsCreateNewFunctionRequestExecutePydantic
from appwrite_server_python_sdk.pydantic.function import Function as FunctionPydantic

from . import path

# body param
SchemaForRequestBodyApplicationJson = FunctionsCreateNewFunctionRequestSchema


request_body_functions_create_new_function_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _create_new_function_mapped_args(
        self,
        function_id: str,
        name: str,
        runtime: str,
        execute: typing.Optional[FunctionsCreateNewFunctionRequestExecute] = None,
        events: typing.Optional[FunctionsCreateNewFunctionRequestEvents] = None,
    ...
    async def _acreate_new_function_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_functions_create_new_function_request.serialize(body, content_type)
...
class CreateNewFunctionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_function(
        self,
        function_id: str,
        name: str,
        runtime: str,
        ...
        **kwargs,
        ...
        args = self._create_new_function_mapped_args(
        ...
        return await self._acreate_new_function_oapg(
            body=args.body,
            **kwargs,
        )
    ...
    def create_new_function(
        ...
        return self._create_new_function_oapg(
            body=args.body,
        )

class CreateNewFunction(BaseApi):
    ...
    async def acreate_new_function(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_function(
            function_id=function_id,
            name=name,
            runtime=runtime,
            execute=execute,
    ...
    def create_new_function(
        ...
        raw_response = self.raw.create_new_function(
            function_id=function_id,
            name=name,
            runtime=runtime,
            execute=execute,
