...
class BaseApi(api_client.Api):
    ...
    def _get_queue_messaging_mapped_args(
        self,
    ...
    async def _aget_queue_messaging_oapg(
        self,
...
class GetQueueMessagingRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_queue_messaging(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_queue_messaging_mapped_args(
            threshold=threshold,
        )
        return await self._aget_queue_messaging_oapg(
    ...
    def get_queue_messaging(
        ...
        return self._get_queue_messaging_oapg(
            query_params=args.query,
        )

class GetQueueMessaging(BaseApi):
    ...
    async def aget_queue_messaging(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_queue_messaging(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_queue_messaging(
        ...
        raw_response = self.raw.get_queue_messaging(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
