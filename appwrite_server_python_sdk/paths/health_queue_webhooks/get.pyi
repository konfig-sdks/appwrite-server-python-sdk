...
class BaseApi(api_client.Api):
    ...
    def _get_webhooks_queue_mapped_args(
        self,
    ...
    async def _aget_webhooks_queue_oapg(
        self,
...
class GetWebhooksQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_webhooks_queue(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_webhooks_queue_mapped_args(
            threshold=threshold,
        )
        return await self._aget_webhooks_queue_oapg(
    ...
    def get_webhooks_queue(
        ...
        return self._get_webhooks_queue_oapg(
            query_params=args.query,
        )

class GetWebhooksQueue(BaseApi):
    ...
    async def aget_webhooks_queue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_webhooks_queue(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_webhooks_queue(
        ...
        raw_response = self.raw.get_webhooks_queue(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
