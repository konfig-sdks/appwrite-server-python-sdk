...
class DeleteIndexRaw(BaseApi):
    ...
    async def adelete_index(
        ...
        **kwargs,
        ...
        args = self._delete_index_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
        )
        return await self._adelete_index_oapg(
...
class DeleteIndex(BaseApi):
    ...
    async def adelete_index(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_index(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
            **kwargs,
    ...
    def delete_index(
        ...
        raw_response = self.raw.delete_index(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
        )
