...
class BaseApi(api_client.Api):
    ...
    def _get_bucket_by_id_mapped_args(
        self,
        bucket_id: str,
    ...
    async def _aget_bucket_by_id_oapg(
        self,
...
class GetBucketByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_bucket_by_id(
        self,
        bucket_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_bucket_by_id_mapped_args(
            bucket_id=bucket_id,
        )
        return await self._aget_bucket_by_id_oapg(
    ...
    def get_bucket_by_id(
        ...
        return self._get_bucket_by_id_oapg(
            path_params=args.path,
        )

class GetBucketById(BaseApi):
    ...
    async def aget_bucket_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_bucket_by_id(
            bucket_id=bucket_id,
            **kwargs,
        )
        if validate:
    ...
    def get_bucket_by_id(
        ...
        raw_response = self.raw.get_bucket_by_id(
            bucket_id=bucket_id,
        )
        if validate:
            return BucketPydantic(**raw_response.body)
