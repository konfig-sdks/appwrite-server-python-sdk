...
class BaseApi(api_client.Api):
    ...
    def _get_session_by_id_mapped_args(
        self,
        session_id: str,
    ...
    async def _aget_session_by_id_oapg(
        self,
...
class GetSessionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_session_by_id(
        self,
        session_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_session_by_id_mapped_args(
            session_id=session_id,
        )
        return await self._aget_session_by_id_oapg(
    ...
    def get_session_by_id(
        ...
        return self._get_session_by_id_oapg(
            path_params=args.path,
        )

class GetSessionById(BaseApi):
    ...
    async def aget_session_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_session_by_id(
            session_id=session_id,
            **kwargs,
        )
        if validate:
    ...
    def get_session_by_id(
        ...
        raw_response = self.raw.get_session_by_id(
            session_id=session_id,
        )
        if validate:
            return SessionPydantic(**raw_response.body)
