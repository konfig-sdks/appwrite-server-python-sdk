...
class BaseApi(api_client.Api):
    ...
    def _queue_certificates_get_mapped_args(
        self,
    ...
    async def _aqueue_certificates_get_oapg(
        self,
    ...
    def _queue_certificates_get_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class QueueCertificatesGetRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aqueue_certificates_get(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._queue_certificates_get_mapped_args(
            threshold=threshold,
        )
        return await self._aqueue_certificates_get_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def queue_certificates_get(
        self,
        threshold: typing.Optional[int] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._queue_certificates_get_oapg(
            query_params=args.query,
        )

class QueueCertificatesGet(BaseApi):
    ...
    async def aqueue_certificates_get(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aqueue_certificates_get(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def queue_certificates_get(
        ...
        raw_response = self.raw.queue_certificates_get(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
