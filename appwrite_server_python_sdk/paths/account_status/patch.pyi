...
class BaseApi(api_client.Api):
    ...
    def _block_current_user_status_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _ablock_current_user_status_oapg(
        self,
    ...
    def _block_current_user_status_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class BlockCurrentUserStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ablock_current_user_status(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._block_current_user_status_mapped_args(
        )
        return await self._ablock_current_user_status_oapg(
            **kwargs,
        )
    
    def block_current_user_status(
        self,
    ) -> typing.Union[
        ApiResponseFor200,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._block_current_user_status_oapg(
        )

class BlockCurrentUserStatus(BaseApi):
    ...
    async def ablock_current_user_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ablock_current_user_status(
            **kwargs,
        )
        if validate:
    ...
    def block_current_user_status(
        ...
        raw_response = self.raw.block_current_user_status(
        )
        if validate:
            return UserPydantic(**raw_response.body)
        return api_client.construct_model_instance(UserPydantic, raw_response.body)
