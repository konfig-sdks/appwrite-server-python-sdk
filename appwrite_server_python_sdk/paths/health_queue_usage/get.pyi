...
class BaseApi(api_client.Api):
    ...
    def _get_queue_usage_mapped_args(
        self,
    ...
    async def _aget_queue_usage_oapg(
        self,
...
class GetQueueUsageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_queue_usage(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_queue_usage_mapped_args(
            threshold=threshold,
        )
        return await self._aget_queue_usage_oapg(
    ...
    def get_queue_usage(
        ...
        return self._get_queue_usage_oapg(
            query_params=args.query,
        )

class GetQueueUsage(BaseApi):
    ...
    async def aget_queue_usage(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_queue_usage(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_queue_usage(
        ...
        raw_response = self.raw.get_queue_usage(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
