...
class BaseApi(api_client.Api):
    ...
    def _get_deletes_queue_mapped_args(
        self,
    ...
    async def _aget_deletes_queue_oapg(
        self,
...
class GetDeletesQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_deletes_queue(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_deletes_queue_mapped_args(
            threshold=threshold,
        )
        return await self._aget_deletes_queue_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_deletes_queue(
        self,
        threshold: typing.Optional[int] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_deletes_queue_oapg(
            query_params=args.query,
        )

class GetDeletesQueue(BaseApi):
    ...
    async def aget_deletes_queue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_deletes_queue(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_deletes_queue(
        ...
        raw_response = self.raw.get_deletes_queue(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
