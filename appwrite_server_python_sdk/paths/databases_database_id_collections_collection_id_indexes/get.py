...
from appwrite_server_python_sdk.model.index_list import IndexList as IndexListSchema

from appwrite_server_python_sdk.type.index_list import IndexList

from ...api_client import Dictionary
from appwrite_server_python_sdk.pydantic.index_list import IndexList as IndexListPydantic
...
class ListIndexesRaw(BaseApi):
    ...
    async def alist_indexes(
        ...
        **kwargs,
        ...
        args = self._list_indexes_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
            queries=queries,
        )
        return await self._alist_indexes_oapg(
    ...
    def list_indexes(
        ...
        return self._list_indexes_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListIndexes(BaseApi):
    ...
    async def alist_indexes(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_indexes(
            database_id=database_id,
            collection_id=collection_id,
            queries=queries,
            **kwargs,
    ...
    def list_indexes(
        ...
        raw_response = self.raw.list_indexes(
            database_id=database_id,
            collection_id=collection_id,
            queries=queries,
        )
