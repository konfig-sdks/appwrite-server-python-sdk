...
class RequiredStorageCreateNewBucketRequest(TypedDict):
...
class OptionalStorageCreateNewBucketRequest(TypedDict, total=False):
    permissions: StorageCreateNewBucketRequestPermissions
    ...
    allowedFileExtensions: StorageCreateNewBucketRequestAllowedFileExtensions
...
class StorageCreateNewBucketRequest(RequiredStorageCreateNewBucketRequest, OptionalStorageCreateNewBucketRequest):
    pass
