...
class RequiredMessagingCreateSendgridProviderRequest(TypedDict):
...
class OptionalMessagingCreateSendgridProviderRequest(TypedDict, total=False):
    # Sendgrid API key.
    apiKey: str
...
class MessagingCreateSendgridProviderRequest(RequiredMessagingCreateSendgridProviderRequest, OptionalMessagingCreateSendgridProviderRequest):
    pass
