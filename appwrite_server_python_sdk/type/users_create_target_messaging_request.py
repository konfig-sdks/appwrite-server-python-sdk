...
class RequiredUsersCreateTargetMessagingRequest(TypedDict):
...
class OptionalUsersCreateTargetMessagingRequest(TypedDict, total=False):
...
class UsersCreateTargetMessagingRequest(RequiredUsersCreateTargetMessagingRequest, OptionalUsersCreateTargetMessagingRequest):
    pass
